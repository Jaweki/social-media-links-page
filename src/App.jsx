...
function App() {
  ...
  return (
    <main className="w-screen h-screen bg-neutral-off-black flex justify-center items-center">
      <div className=" w-[320px] bg-neutral-dark-grey rounded-lg flex flex-col items-center justify-center space-y-7 p-6" >

        <img src={"./images/avatar-jessica.jpeg"} alt="" className="rounded-full h-20 w-20"/>
        <p>
